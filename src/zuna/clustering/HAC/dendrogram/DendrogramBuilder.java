...
import zuna.clustering.HAC.ClusteringBuilder;
...
public final class DendrogramBuilder implements ClusteringBuilder {
    ...
    public DendrogramBuilder(final int nObservations, ArrayList<String> obv) {
        nodes = new DendrogramNode[nObservations];
        for (int i = 0; i<nObservations; i++) {
            nodes[i] = new ObservationNode(i, obv.get(i));
        }
    }
