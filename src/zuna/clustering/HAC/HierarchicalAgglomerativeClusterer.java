...
public final class HierarchicalAgglomerativeClusterer {
    ...
    public HierarchicalAgglomerativeClusterer(final Experiment experiment2, 
    		final DissimilarityMeasure dissimilarityMeasure, final AgglomerationMethod agglomerationMethod) {
